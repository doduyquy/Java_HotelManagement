...
import GUI.GUI_DICHVU.PanelDichVu;
import GUI.GUI_FUNCTION_ACCOUNT.FormLogin;
import GUI.GUI_HOADON.HoaDonGUI;
import GUI.GUI_HOME.PanelHome;
import GUI.GUI_KHACHHANG.PanelKhachHang;
import GUI.GUI_NHANVIEN.PanelNhanVien;
import GUI.GUI_PHONG.PanelPhong;
import GUI.GUI_THONGKE.ThongKeGUI;
import java.awt.*;
...
public class ManagerGUI extends JFrame {
    ...
    public void initComponents() {
        ...
        JButton btn2 = new JButton(" Quản lý Phòng");
        JButton btn3 = new JButton(" Quản lý Dịch vụ");
        JButton btn4 = new JButton(" Quản lý Nhân viên");
        JButton btn5 = new JButton(" Quản lý Khách hàng");
        JButton btn6 = new JButton(" Quản lý Hoá đơn");
        JButton btn7 = new JButton(" Quản lý Thống kê");
        ...
        btn1.setIcon(icon1);
        ImageIcon icon2 = new ImageIcon(new ImageIcon(getClass().getResource("/GUI/assets/phong.png")).getImage().getScaledInstance(30, 30, Image.SCALE_SMOOTH));
        btn2.setIcon(icon2);
        ...
        btn4.setIcon(icon4);
        ImageIcon icon5 = new ImageIcon(new ImageIcon(getClass().getResource("/GUI/assets/diemdanh.png")).getImage().getScaledInstance(30, 30, Image.SCALE_SMOOTH));
        btn5.setIcon(icon5);
        ImageIcon icon6 = new ImageIcon(new ImageIcon(getClass().getResource("/GUI/assets/thanhtoan.png")).getImage().getScaledInstance(30, 30, Image.SCALE_SMOOTH));
        btn6.setIcon(icon6);
        ImageIcon icon7 = new ImageIcon(new ImageIcon(getClass().getResource("/GUI/assets/thongke.png")).getImage().getScaledInstance(30, 30, Image.SCALE_SMOOTH));
        btn7.setIcon(icon7);
        //action hover menu
        setMouse();
        //action hover mode
...
//        showToolTip();
    ...
    public void setDisplayHeader(JPanel pnHeader) {
        ...
        //set img logo
        ImageIcon iconLogo = new ImageIcon(new ImageIcon(getClass().getResource("/GUI/assets/hotel.png")).getImage().getScaledInstance(80, 50, Image.SCALE_SMOOTH));
    ...
    public void showText() {
        ...
        btnMenu.get(1).setText(" Quản lý Phòng");
        btnMenu.get(2).setText(" Quản lý Dịch vụ");
        btnMenu.get(3).setText(" Quản lý Nhân viên");
        btnMenu.get(4).setText(" Quản lý Khách hàng");
        btnMenu.get(5).setText(" Quản lý Hóa đơn");
        btnMenu.get(6).setText(" Quản lý Thống kê");
