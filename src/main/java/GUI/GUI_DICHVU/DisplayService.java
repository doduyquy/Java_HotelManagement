...
public class DisplayService extends JPanel {
        ...
        try {
            ...
            for (Row row : sheet) {
                ...
                if (temp.getMaDV().equals("") && temp.getTenDV().equals("") && temp.getHinhAnh().equals("") && temp.getLoaiDV().equals("")) {
                    ...
                    JOptionPane.showMessageDialog(this, String.format("row %d: ", row.getRowNum())
    ...
    private int validateNVDTO(DichVuDTO x, int row) {
        ...
        String path = System.getProperty("user.dir") + x.getHinhAnh();
        ...
        int result = JOptionPane.showConfirmDialog(this, String.format("row %d: \n", row)
                ...
                + String.format("Tên DV: %s \n", x.getTenDV())
                + String.format("Hình DV: %s \n", x.getHinhAnh())
                + String.format("Loại DV: %s \n", x.getLoaiDV())
                + String.format("Giá DV: %d \n", x.getGiaDV()),
