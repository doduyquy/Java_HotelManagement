...
public class TableTaiKhoanCellRenderer extends DefaultTableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        lb.setHorizontalAlignment((column == table.getColumnModel().getColumnIndex("Vai trò") || column == table.getColumnModel().getColumnIndex("Tình trạng")) ? JLabel.RIGHT
